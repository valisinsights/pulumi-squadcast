...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `squadcast` with the `NAME` of your provider.
...
├── config.yaml
├── metadata.json
├── pulumi-squadcast_darwin_amd64_v1
│   └── pulumi-resource-squadcast
├── pulumi-squadcast_darwin_arm64
│   └── pulumi-resource-squadcast
├── pulumi-squadcast_linux_amd64_v1
│   └── pulumi-resource-squadcast
├── pulumi-squadcast_linux_arm64
│   └── pulumi-resource-squadcast
├── pulumi-squadcast_windows_amd64_v1
│   └── pulumi-resource-squadcast.exe
└── pulumi-squadcast_windows_arm64
    └── pulumi-resource-squadcast.exe
```
