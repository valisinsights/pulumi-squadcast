...
namespace Pulumi.Squadcast
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Squadcast.version.txt");
    ...
    internal sealed class SquadcastResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SquadcastResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
