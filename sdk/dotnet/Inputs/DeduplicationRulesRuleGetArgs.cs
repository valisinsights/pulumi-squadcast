...
namespace Pulumi.Squadcast.Inputs
{
    ...
    public sealed class DeduplicationRulesRuleGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("basicExpressions")]
        private InputList<Inputs.DeduplicationRulesRuleBasicExpressionGetArgs>? _basicExpressions;

        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        public InputList<Inputs.DeduplicationRulesRuleBasicExpressionGetArgs> BasicExpressions
        {
            get => _basicExpressions ?? (_basicExpressions = new InputList<Inputs.DeduplicationRulesRuleBasicExpressionGetArgs>());
        ...
        public DeduplicationRulesRuleGetArgs()
        {
        }
        public static new DeduplicationRulesRuleGetArgs Empty => new DeduplicationRulesRuleGetArgs();
    }
}
