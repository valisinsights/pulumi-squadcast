...
namespace Pulumi.Squadcast.Inputs
{
    ...
    public sealed class SuppressionRulesRuleArgs : global::Pulumi.ResourceArgs
    {
        [Input("basicExpressions")]
        private InputList<Inputs.SuppressionRulesRuleBasicExpressionArgs>? _basicExpressions;

        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        public InputList<Inputs.SuppressionRulesRuleBasicExpressionArgs> BasicExpressions
        {
            get => _basicExpressions ?? (_basicExpressions = new InputList<Inputs.SuppressionRulesRuleBasicExpressionArgs>());
        ...
        [Input("timeslots")]
        private InputList<Inputs.SuppressionRulesRuleTimeslotArgs>? _timeslots;

        /// <summary>
        /// The timeslots for which this rule should be applied.
        /// </summary>
        public InputList<Inputs.SuppressionRulesRuleTimeslotArgs> Timeslots
        {
            get => _timeslots ?? (_timeslots = new InputList<Inputs.SuppressionRulesRuleTimeslotArgs>());
            set => _timeslots = value;
        }

        public SuppressionRulesRuleArgs()
        {
        }
        public static new SuppressionRulesRuleArgs Empty => new SuppressionRulesRuleArgs();
    }
}
