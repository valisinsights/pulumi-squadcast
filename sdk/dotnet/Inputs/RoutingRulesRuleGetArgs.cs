...
namespace Pulumi.Squadcast.Inputs
{
    ...
    public sealed class RoutingRulesRuleGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("basicExpressions")]
        private InputList<Inputs.RoutingRulesRuleBasicExpressionGetArgs>? _basicExpressions;

        /// <summary>
        /// The basic expression which needs to be evaluated to be true for this rule to apply.
        /// </summary>
        public InputList<Inputs.RoutingRulesRuleBasicExpressionGetArgs> BasicExpressions
        {
            get => _basicExpressions ?? (_basicExpressions = new InputList<Inputs.RoutingRulesRuleBasicExpressionGetArgs>());
        ...
        public RoutingRulesRuleGetArgs()
        {
        }
        public static new RoutingRulesRuleGetArgs Empty => new RoutingRulesRuleGetArgs();
    }
}
