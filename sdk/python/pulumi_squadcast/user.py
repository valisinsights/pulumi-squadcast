...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role: User role.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] abilities: user abilities/permissions.
        """
...
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def abilities(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        user abilities/permissions.
        """
        return pulumi.get(self, "abilities")
